 ...
 */
module.exports = class AutoMigration1763877369821 {
    name = 'AutoMigration1763877369821'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "employees" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "active" boolean NOT NULL DEFAULT true, "companyId" uuid NOT NULL, "personId" uuid NOT NULL, "roleId" uuid, "roleTypeId" uuid, "teamId" uuid, "userId" uuid, "departmentId" uuid, "branchId" uuid, "wage" numeric, "hiringDate" date NOT NULL, "departureDate" date, CONSTRAINT "UQ_f8622c4234d453ddb23b46bc776" UNIQUE ("companyId", "personId"), CONSTRAINT "PK_b9535a98350d5b26e7eb0c26af4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."evaluation_types_code_enum" AS ENUM('HIGHER_BETTER_SUM', 'LOWER_BETTER_SUM', 'HIGHER_BETTER_PCT', 'LOWER_BETTER_PCT', 'BINARY')`);
        ...
        await queryRunner.query(`CREATE TABLE "team_kpi_evolutions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "active" boolean NOT NULL DEFAULT true, "companyId" uuid NOT NULL, "teamId" uuid NOT NULL, "teamKpiId" uuid NOT NULL, "achievedValueEvolution" character varying, "status" "public"."team_kpi_evolutions_status_enum" NOT NULL DEFAULT 'DRAFT', "submittedBy" uuid NOT NULL, "submittedDate" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "approvedBy" uuid, "approvedDate" TIMESTAMP WITH TIME ZONE, "rejectionReason" text, CONSTRAINT "uq_team_kpi_ev_period" UNIQUE ("companyId", "teamId", "teamKpiId", "submittedDate"), CONSTRAINT "PK_c84b7ed1a44fa18a6765ece05b5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."employee_kpis_status_enum" AS ENUM('DRAFT', 'SUBMITTED', 'APPROVED', 'REJECTED')`);
        await queryRunner.query(`CREATE TABLE "employee_kpis" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "active" boolean NOT NULL DEFAULT true, "companyId" uuid NOT NULL, "employeeId" uuid NOT NULL, "teamId" uuid NOT NULL, "kpiId" uuid NOT NULL, "evaluationTypeId" uuid NOT NULL, "periodStart" date NOT NULL, "periodEnd" date NOT NULL, "goal" character varying, "achievedValue" character varying, "raterEmployeeId" uuid, "status" "public"."employee_kpis_status_enum" NOT NULL DEFAULT 'DRAFT', "submittedBy" uuid NOT NULL, "submittedDate" TIMESTAMP WITH TIME ZONE NOT NULL, "approvedBy" uuid, "approvedDate" TIMESTAMP WITH TIME ZONE, "rejectionReason" text, CONSTRAINT "uq_emp_kpi_period" UNIQUE ("companyId", "employeeId", "kpiId", "periodStart", "periodEnd"), CONSTRAINT "PK_2992520e9a06ddc7e8482ab8e94" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "employee_kpi_evolutions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "active" boolean NOT NULL DEFAULT true, "companyId" uuid NOT NULL, "employeeId" uuid NOT NULL, "teamId" uuid NOT NULL, "employeeKpiId" uuid NOT NULL, "achievedValueEvolution" character varying, "raterEmployeeId" uuid, "status" "public"."employee_kpi_evolutions_status_enum" NOT NULL DEFAULT 'DRAFT', "submittedBy" uuid NOT NULL, "submittedDate" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "approvedBy" uuid, "approvedDate" TIMESTAMP WITH TIME ZONE, "rejectionReason" text, CONSTRAINT "uq_emp_kpi_ev_period" UNIQUE ("companyId", "employeeId", "employeeKpiId", "submittedDate"), CONSTRAINT "PK_b2b38c14233350501cbfb923f16" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "employee_histories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "active" boolean NOT NULL DEFAULT true, "companyId" uuid NOT NULL, "employeeId" uuid NOT NULL, "roleId" uuid, "roleTypeId" uuid, "teamId" uuid, "departmentId" uuid, "branchId" uuid, "wage" numeric, "hiringDate" date NOT NULL, "departureDate" date, "startDate" date NOT NULL, "endDate" date, CONSTRAINT "PK_d2f861b631a7fddef2c9b9338ae" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "career_paths" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "active" boolean NOT NULL DEFAULT true, "companyId" uuid NOT NULL, "name" character varying NOT NULL, "description" text, "currentRoleId" uuid NOT NULL, "nextRoleId" uuid NOT NULL, "sortOrder" integer NOT NULL DEFAULT '0', "isEntryPoint" boolean NOT NULL DEFAULT false, "departmentId" uuid, CONSTRAINT "uq_career_path_edge" UNIQUE ("companyId", "departmentId", "currentRoleId", "nextRoleId"), CONSTRAINT "PK_2051ef7b447c3939c5177a10f3c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "employee_kpi_evolutions" ADD CONSTRAINT "FK_36d5548fdd3e80274ed6bfa6282" FOREIGN KEY ("teamId") REFERENCES "teams"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "career_paths" ADD CONSTRAINT "FK_fe77f561fc56ff871fad64b433e" FOREIGN KEY ("departmentId") REFERENCES "departments"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "career_paths" ADD CONSTRAINT "FK_f8bb2720f3ed9937b88b9e5b1ae" FOREIGN KEY ("currentRoleId") REFERENCES "roles"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "career_paths" ADD CONSTRAINT "FK_c2ab19fe98a318ef01196608e26" FOREIGN KEY ("nextRoleId") REFERENCES "roles"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
    }
    ...
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "career_paths" DROP CONSTRAINT "FK_c2ab19fe98a318ef01196608e26"`);
        await queryRunner.query(`ALTER TABLE "career_paths" DROP CONSTRAINT "FK_f8bb2720f3ed9937b88b9e5b1ae"`);
        await queryRunner.query(`ALTER TABLE "career_paths" DROP CONSTRAINT "FK_fe77f561fc56ff871fad64b433e"`);
        ...
        await queryRunner.query(`ALTER TABLE "employee_kpi_evolutions" DROP CONSTRAINT "FK_36d5548fdd3e80274ed6bfa6282"`);
