 ...
 */
module.exports = class AutoMigration1761960407724 {
    name = 'AutoMigration1761960407724'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "employee_kpis" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "active" boolean NOT NULL DEFAULT true, "companyId" uuid NOT NULL, "employeeId" uuid NOT NULL, "kpiId" uuid NOT NULL, "evaluationTypeId" uuid NOT NULL, "periodStart" date NOT NULL, "periodEnd" date NOT NULL, "goal" numeric, "achievedValue" numeric, "raterEmployeeId" uuid, "status" "public"."employee_kpis_status_enum" NOT NULL DEFAULT 'DRAFT', "submittedBy" uuid NOT NULL, "submittedDate" TIMESTAMP WITH TIME ZONE NOT NULL, "approvedBy" uuid, "approvedDate" TIMESTAMP WITH TIME ZONE, "rejectionReason" text, CONSTRAINT "uq_emp_kpi_period" UNIQUE ("companyId", "employeeId", "kpiId", "periodStart", "periodEnd"), CONSTRAINT "PK_2992520e9a06ddc7e8482ab8e94" PRIMARY KEY ("id"))`);
